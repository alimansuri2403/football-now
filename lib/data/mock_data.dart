  ...
  static List<Match> getMatches() {
    ...
    return [
      ...
      Match(
        ...
        minute: 72,
        kickoffTime: DateTime.now().subtract(const Duration(minutes: 72)),
      ...
      Match(
        ...
        status: MatchStatus.live,
        minute: 88,
        kickoffTime: DateTime.now().subtract(const Duration(minutes: 88)),
      ...
      Match(
        ...
        kickoffTime: DateTime.now().add(const Duration(hours: 4)),
      ...
      Match(
        ...
        awayScore: 0,
        status: MatchStatus.scheduled,
        kickoffTime: DateTime.now().add(const Duration(days: 1, hours: 2)),
